<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/NEW_HOTEL/NEW_HOTEL.Master" CodeBehind="~/NEW_HOTEL/NewHotel.aspx.vb" Inherits="WebApp.NewHotel" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style=" margin-top:40px; vertical-align:middle; text-align: center; height : 1580px; background-image:url(https://tesipro.com/wp-content/uploads/2013/08/Booking2-tesipro-1.jpg)">
        
        <div  class="col-md-12" style="vertical-align:middle; text-align: center;" >
            <h2>
                <br />
                <asp:Button ID="Button1" CssClass="btn btn-success"  runat="server" Text="Crear Hotel Nuevo" Width="179px" />
                <br />
                 <asp:GridView ID="GridView1"   class="table" HorizontalAlign="Center" style="text-align:center;overflow-x :AUTO" runat="server" AutoGenerateColumns="False"  DataSourceID="SqlTest2" BorderStyle="Solid" Font-Bold="True" Width="69px" BackColor="White" BorderColor="#999999" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" Font-Size="Medium" Height="222px">
