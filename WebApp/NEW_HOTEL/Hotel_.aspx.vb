...
Public Class Hotel_
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            SqlTest2.ConnectionString = SingletonDb.GetInstance.GetConnectionString
        ...
        If Session("TECNICO") = True Then
            SqlTest2.SelectCommand = "SELECT [ID],[GRUPO], [NOMBRE_CORTO], NEW_HOTEL FROM HOTELES  where new_hotel = 'false'   ORDER BY [GRUPO]"
            'Else
            '    If Session("INSTALACION") = True Then
            '        SqlTest2.SelectCommand = "SELECT [ID],[GRUPO], [NOMBRE_CORTO], NEW_HOTEL FROM HOTELES H LEFT JOIN HOTEL_PERMISO HP ON H.ID = HP.FK_ID_HOTEL  where new_hotel = 'true' AND HP.FK_ID_USUARIO = '" & Session("id_usuario") & "'  ORDER BY [GRUPO]"
    ...
    Protected Sub GridView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Session("HotelDatos") = False      'esto es para activar el pull de datos 
        ' MsgBox(Session("test"))
        Session("test") = Index
