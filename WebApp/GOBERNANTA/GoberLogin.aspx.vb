...
Public Class GoberLogin
    ...
    Public Sub login(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            sql_query.Connection = Cn
            Cn.Open()
            sql_query.CommandText = "SELECT * FROM MANTENIMIENTO_USUARIO_GOBER WHERE USUARIO = '" & TextBox1.Text & "'"
        ...
        Else
            ...
            Response.Redirect("~/GOBERNANTA/GOBER_RACK.aspx")
        End If
