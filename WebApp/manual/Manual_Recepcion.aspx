<%@ Page Title="" Language="VB" AutoEventWireup="false" MasterPageFile="~/manual/MANUAL_TECNICO.Master"  CodeBehind="Manual_Recepcion.aspx.vb" Inherits="WebApp.Manual_Recepcion" %>
        ...
        <div class="col-md-12">
            ...
            <p>
                ...
                <asp:DropDownList ID="DropDownList1" AutoPostBack="true" runat="server" Width="297px" style="margin-right: 30px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    ...
                    <asp:ListItem>1 - CHECK-IN</asp:ListItem>
                    <asp:ListItem>2 - RACK</asp:ListItem>
                    <asp:ListItem>3 - PLANNING</asp:ListItem>
                    <asp:ListItem>4 - CONSULTA CLIENTES</asp:ListItem>
                    <asp:ListItem>5 - CONSULTA OCUPACION</asp:ListItem>
                    <asp:ListItem>6 - CIERRE DIARIO</asp:ListItem>
                </asp:DropDownList>
                <br />
                <br />
                <br />
