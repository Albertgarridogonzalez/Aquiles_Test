<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/manual/MANUAL_TECNICO.Master" CodeBehind="ManualLogin.aspx.vb" Inherits="WebApp.ManualLogin" %>
...
&nbsp;<asp:LinkButton ID="LinkButton2" runat="server">Recovery Password</asp:LinkButton>
        <br />
&nbsp;&nbsp;&nbsp;
        <asp:CheckBox ID="CheckBox1" runat="server" Text="MODO DEBUG&quot;NoUsar&quot;" Visible="False" />
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;
