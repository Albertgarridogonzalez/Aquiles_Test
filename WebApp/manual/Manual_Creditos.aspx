<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/manual/MANUAL_TECNICO.Master"  CodeBehind="Manual_Creditos.aspx.vb" Inherits="WebApp.Manual_Creditos" %>
        ...
        <div class="col-md-12">
            ...
            <p>
                ...
                <asp:DropDownList ID="DropDownList1" AutoPostBack="true" runat="server" Width="297px" style="margin-right: 30px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                    ...
                    <asp:ListItem>1 - CREDITOS</asp:ListItem>
